...
class rangerBot(sc2.BotAI):
    ...
    async def build_assimiltors(self):
    ...
    async def build_offensive_force(self):
        ...
        for sw in self.units(STARGATE).ready.noqueue:
            if self.can_afford(VOIDRAY) and self.supply_left >0:
                await self.do(sw.train(VOIDRAY))
